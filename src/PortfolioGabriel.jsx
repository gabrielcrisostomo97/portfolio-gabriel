    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <section id="sobre" className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="rounded-3xl p-5 bg-neutral-900 border border-neutral-800">
            <h3 className="font-semibold mb-2 flex items-center gap-2"><Briefcase className="w-4 h-4"/> Interesses</h3>
      ...
      <section id="skills" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {skills.map((s) => (
            <motion.div key={s} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-2xl border border-neutral-800 p-4">
      ...
      <section id="projetos" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((p) => (
            <motion.article key={p.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-3xl border border-neutral-800 bg-neutral-900 p-6">
              <h3 className="text-xl font-semibold mb-2">{p.title}</h3>
              <p className="text-neutral-300 mb-4">{p.desc}</p>
              <a href={p.link} target="_blank" className="inline-flex items-center gap-2 text-sm underline hover:no-underline">
      ...
      <section id="contato" className="max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-3xl border border-neutral-800 p-6 bg-neutral-900">
          ...
          <p className="text-neutral-300 mt-2">Aberto a oportunidades como Desenvolvedor Front‑End Júnior em Fortaleza/Remoto.</p>
          <div className="mt-4 flex flex-wrap gap-3">
            <a href="mailto:biel.cristian@hotmail.com" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-neutral-800 hover:bg-neutral-700 transition"><Mail className="w-4 h-4"/> biel.cristian@hotmail.com</a>
            <a href="https://github.com/gabrielcrisostomo97" target="_blank" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-neutral-800 hover:bg-neutral-700 transition"><Github className="w-4 h-4"/> github.com/gabrielcrisostomo97</a>
            <a href="https://www.linkedin.com/in/gabriel-crisostomo/" target="_blank" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-neutral-800 hover:bg-neutral-700 transition"><Linkedin className="w-4 h-4"/> linkedin.com/in/gabriel-crisostomo</a>
          </div>
        </div>
      </section>
